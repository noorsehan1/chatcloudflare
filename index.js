...
export class ChatServer2 {
  ...
  assignNewSeat(room, userId) {
    ...
    try {
      ...
      // ⭐ HANYA assign user ID, TIDAK buat data baru
      const seatData = {
        noimageUrl: "",
        namauser: userId,
        color: "",
    ...
    try {
      switch (evt) {
        ...
        case "updateKursi": {
          ...
          // ⭐ Update data seat dengan data baru dari user (MANUAL UPDATE)
          const updatedSeat = {
